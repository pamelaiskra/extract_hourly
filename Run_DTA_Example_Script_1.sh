...
#-----------Note:
#------------DEM.asc, river.asc and gauges_list1.txt need to be in MAIN_DIR
#-----------gauges_list1.txt contains XY coords for ALL stations
#-----------Output folder is DTA_23016, has to be created manually
...
#MAIN_DIR=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/DTA_23016
MAIN_DIR=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/DTA_28039
