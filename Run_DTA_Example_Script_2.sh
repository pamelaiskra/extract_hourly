...
#-----------Note:
#------------classic.dat,gauge_list2.txt,hru_class.dat need to be in OUTPUT_DIR
#-----------gauge_lis2.txt contains list of gauges for simulation folowwed by 000
#-----------Output folder is HRU_23016 
...
CODE_DIR=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/DTA

# Your working folder for the first part of the DTA analysis and the root file name for the DEM
# THIS MUST BE CHANGED
#ROOT_FN=/data/DYMOND/DTA/DEM
#ROOT_FN=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/DTA_23016/newcgb3dem
ROOT_FN=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/DTA_28039/birm_dem

#The output folder you want to put the results in 
# THIS MUST BE CHANGED
#OUTPUT_DIR=/data/DYMOND/DTA/HRU
#OUTPUT_DIR=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/HRU_23016_GEAR
#OUTPUT_DIR=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/HRU_23016_WRF
#OUTPUT_DIR=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/HRU_28039_GEAR
OUTPUT_DIR=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/HRU_28039_WRF

#Text file listing NRFA Gauge IDs that you want to model
GAUGELIST=${OUTPUT_DIR}/gauge_list2.txt
...
#CATCHMASK_DIR=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/DTA_23016/masks/
CATCHMASK_DIR=/panfs/panasas01/geog/pm15021/DECIPHeR_v2/DTA_28039/masks/
